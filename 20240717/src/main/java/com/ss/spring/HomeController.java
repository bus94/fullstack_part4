...
public class HomeController {
	...
	// - URl 매핑이 되어있는 메서드를 말한다.
	// - 특정 단위 하나의 기능을 담당하는 것
	// - return 값이 문자열일 경우 기본적으로 forward 되는 jsp 페이지를 
	...
	public String home2() {
		return "home2"; // /WEB-INF/views/home2.jsp로 URL이 완성된다. (원래는 viewpage로 switch문으로 문자열을 붙여서 작성했던 내용들)
	}
	
//	// home2의 메서드 이름과 가장 유사한 jsp를 자동으로 찾아 실행해준다. (return을 안 써도 메서드명으로 jsp 찾아줌) - 그러나 에러나기 쉬우니 추천x (중복 등의 경우의 수가 생긴다)
//	@RequestMapping("home2.do")
//	public void home2() {}
	
	// Redirect로 home2.do로 전달하는 방법
	// 기본적으로 forward되는 방식이지만 새로운 요청을 바로 할 수 있다.
	// return "home2.do"; 로만 리턴하면 /WEB-INF/views/home2.do.jsp로 주소 왜곡이 난다.
